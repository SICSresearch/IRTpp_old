...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type notEstimated(notEstimatedSEXP);
    __result = Rcpp::wrap(irtppmultidim(ndatSet, e_model, quads, initvals, dimension, notEstimated));
    return __result;
END_RCPP
}
